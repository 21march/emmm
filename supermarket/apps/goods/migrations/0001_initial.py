# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-09-25 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', models.CharField(blank=True, max_length=255, null=True, verbose_name='活动专区简介')),
                ('order', models.SmallIntegerField(default=0, verbose_name='排序')),
                ('is_on_sale', models.SmallIntegerField(choices=[(0, '下架'), (1, '上架')], default=0, verbose_name='是否上架')),
            ],
            options={
                'verbose_name': '首页活动专区管理',
                'verbose_name_plural': '首页活动专区管理',
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('activity_zone', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.ActivityZone', verbose_name='活动专区ID')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('name', models.CharField(max_length=150, verbose_name='商品活动名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('img_url', models.ImageField(upload_to='goods_gallery/%Y%m/%d', verbose_name='商品相册路径')),
            ],
            options={
                'verbose_name': '商品相册管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Categroy', verbose_name='商品分类')),
            ],
            options={
                'verbose_name': '商品SKU名称',
                'verbose_name_plural': '商品SKU名称',
            },
        ),
        migrations.CreateModel(
            name='GoodsSPU',
            ...
            options={
                ...
                'verbose_name_plural': '商品SPU(大分类)管理',
            },
        ),
        migrations.CreateModel(
            name='Unit',
        ...
        migrations.AddField(
            model_name='goodssku',
            name='goods_spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsSPU', verbose_name='商品SPU名称'),
        ),
        migrations.AddField(
            model_name='goodssku',
            name='unit',
        ...
        migrations.AddField(
            model_name='gallery',
            name='goods_sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsSKU', verbose_name='SKU名称'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods_sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsSKU', verbose_name='SKU商品'),
        ),
        migrations.AddField(
            model_name='activityzonegoods',
            name='goods_sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsSKU', verbose_name='专区商品SKU_ID'),
        ),
    ]
